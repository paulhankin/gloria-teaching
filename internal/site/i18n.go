...
var translations = map[string]map[string]string{
	"en": {
		...
		"friends.none":       "No friends yet. Send a friend request below!",
		"friends.incoming":   "Friend requests",
		"friends.outgoing":   "Requests you sent",
		...
		"friends.wants":      "wants to be your friend",
		"friends.pending":    "Request sent — waiting for them to accept",
		"friends.unknown":    "There is no user with that name.",
		"friends.self":       "You cannot befriend yourself.",
		"friends.sentok":     "Friend request sent!",
	...
	"de": {
		...
		"friends.none":       "Noch keine Freunde. Sende unten eine Freundschaftsanfrage!",
		"friends.incoming":   "Freundschaftsanfragen",
		...
		"friends.wants":      "möchte dein Freund sein",
		"friends.pending":    "Anfrage gesendet — wartet auf Annahme",
		"friends.unknown":    "Es gibt keinen Benutzer mit diesem Namen.",
		"friends.self":       "Du kannst dich nicht selbst als Freund hinzufügen.",
		"friends.sentok":     "Freundschaftsanfrage gesendet!",
